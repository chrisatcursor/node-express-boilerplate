...
(module as any).exports = paginate; // TODO(ts-migration): required for CJS consumers during mixed JS/TS migration
// eslint-disable-next-line @typescript-eslint/no-explicit-any
(module as any).exports.default = paginate; // TODO(ts-migration): preserve default export shape for mixed interop
